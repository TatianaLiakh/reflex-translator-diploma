...
public class RegisterImpl extends MinimalEObjectImpl.Container implements Register
{
   ...
   * @ordered
   */
  protected static final int ADDR1_EDEFAULT = 0;
   ...
   * @ordered
   */
  protected int addr1 = ADDR1_EDEFAULT;
   ...
   * @ordered
   */
  protected static final int ADDR2_EDEFAULT = 0;
   ...
   * @ordered
   */
  protected int addr2 = ADDR2_EDEFAULT;
   ...
   */
  @Override
  public void setAddr1(int newAddr1)
  {
    int oldAddr1 = addr1;
    addr1 = newAddr1;
    if (eNotificationRequired())
   ...
   */
  @Override
  public void setAddr2(int newAddr2)
  {
    int oldAddr2 = addr2;
    addr2 = newAddr2;
    if (eNotificationRequired())
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case ReflexPackage.REGISTER__NAME:
        ...
        return;
      case ReflexPackage.REGISTER__ADDR1:
        setAddr1((Integer)newValue);
        return;
      case ReflexPackage.REGISTER__ADDR2:
        setAddr2((Integer)newValue);
        return;
      case ReflexPackage.REGISTER__REG_SIZE:
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case ReflexPackage.REGISTER__ADDR1:
        return addr1 != ADDR1_EDEFAULT;
      case ReflexPackage.REGISTER__ADDR2:
        return addr2 != ADDR2_EDEFAULT;
      case ReflexPackage.REGISTER__REG_SIZE:
